...
public abstract class Entity
{
    ...
    public static double norenderenabled = 64.0;
    ...
    public float getPosX(Entity par1Entity) {
    	float var1 = (float) par1Entity.posX;
    	return var1;
    }
    
    public String getusername(Entity par1Entity) {
    	String var1 = par1Entity.getEntityName();
    	return var1;
    }
    
    
    public float getPosZ(Entity par1Entity) {
    	float var1 = (float) par1Entity.posZ;
    	return var1;
    }
    public float getPosY(Entity par1Entity) {
    ...
    public boolean isInRangeToRenderDist(double par1)
    {
        ...
        var3 *= norenderenabled * this.renderDistanceWeight;
