...
public class Timer
{
	...
	public static Float CustomTimer = 1.0F;
    ...
    public static float timerSpeed = CustomTimer;
    ...
    public void updateTimer()
    {
        ...
        this.elapsedPartialTicks = (float)((double)this.elapsedPartialTicks + var13 * (double)this.CustomTimer * (double)this.ticksPerSecond);
