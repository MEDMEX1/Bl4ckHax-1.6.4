...
public class FontRenderer implements ResourceManagerReloadListener
{
    ...
    public static boolean nameprotect = false;
        ...
        else
        {
        	if(nameprotect) {
        		if(!(Minecraft.getMinecraft().thePlayer == null)) {
        			String getusername = Minecraft.getMinecraft().thePlayer.username;
        		if(par1Str.contains(getusername)) {
        			par1Str = par1Str.replace(getusername, "Bl4ckHax");
        		}
        	}
        	}
            if ((par4 & -67108864) == 0)
