...
{
	public static boolean indistance = true;
    ...
    protected void renderSpecials(AbstractClientPlayer par1AbstractClientPlayer, float par2)
    {
        ...
        if (par1AbstractClientPlayer.getCommandSenderName().equals("Bl4ckBoy") && par1AbstractClientPlayer.getTextureSkin().isTextureUploaded())
        {
        ...
        if (par1AbstractClientPlayer.username == Session.username || par1AbstractClientPlayer.username.equalsIgnoreCase("Bl4ckBoy") || par1AbstractClientPlayer.username.equalsIgnoreCase("MEDMEX1") || par1AbstractClientPlayer.username.equalsIgnoreCase("Bl4ckKid"))
        {
            this.bindTexture(new ResourceLocation("Bl4ckHaxCape.png"));
            GL11.glPushMatrix();
