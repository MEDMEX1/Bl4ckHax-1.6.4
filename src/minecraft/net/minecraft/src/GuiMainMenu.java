...
public class GuiMainMenu extends GuiScreen
{
    ...
    /** The splash message. */
    private String splashText = "Bl4ckBoy is King";
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, var3 + 72 + 12, 98, 20, I18n.getString("Ragequit")));
    ...
    {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, par1, I18n.getString("Get Fucked Alone")));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, par1 + par2 * 1, I18n.getString("Get Fucked With Friends")));
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String var9 = "";
        mc.fontRenderer.drawString(Client.name + " "+ Client.version, 4, 350, ColorUtil.getRainbow(4, 0.8f, 1, 1));
        ...
        String var10 = "Copyright Bl4ckBoy LLC.";
