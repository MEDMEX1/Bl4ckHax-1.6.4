...
public class PlayerControllerMP
{
    ...
    {
    	if(speedmine == true) blockHitDelay = 0;
        ...
        else
        {
            if (this.sameToolAndBlock(par1, par2, par3))
            {
                ...
                if(speedmine == true) {
                	this.curBlockDamageMP += var6.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, par1, par2, par3) *1.1;
