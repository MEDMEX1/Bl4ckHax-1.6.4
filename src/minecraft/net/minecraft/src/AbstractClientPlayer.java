...
public abstract class AbstractClientPlayer extends EntityPlayer
{
    ...
    {
        return String.format("http://icebergcraft.com:6543/api/Minecraft/GetSkinByUsername/?username=%s.png", new Object[] {StringUtils.stripControlCodes(par0Str)});
    }

    public static String getCapeUrl(String par0Str)
    {
        return String.format("http://icebergcraft.com:6543/api/Minecraft/GetCapeByUsername/?username=", new Object[] {StringUtils.stripControlCodes(par0Str)});
    }
