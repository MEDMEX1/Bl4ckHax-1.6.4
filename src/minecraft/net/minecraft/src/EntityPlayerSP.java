...
import MEDMEX.events.EventType;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
	...
	public static boolean antiportaltrap = false;
    ...
    public void onLivingUpdate()
    {
    	...
    	EventMotion event = new EventMotion(this.posX, this.boundingBox.minY, this.posY, this.posZ);
