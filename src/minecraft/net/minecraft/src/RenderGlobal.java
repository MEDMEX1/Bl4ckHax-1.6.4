...
public class RenderGlobal implements IWorldAccess
{
	...
	public static double waypointZ = 0;
    ...
    public static void drawTracerESP(double d, double d1, double d2) {
		...
		GL11.glColor4f(255.0F, 0.0F, 0.0F, 0.3F);
    ...
    public static void drawAuraESP(double d, double d1, double d2) {
		...
		GL11.glEnable(GL11.GL_LINE_SMOOTH);
		drawOutlinedBoundingBox(new AxisAlignedBB(d - 0.5D, d1 + 0.10000000000000001D, d2 - 0.5D, d + 0.5D, d1 + 2D, d2 + 0.5D));
		GL11.glColor4f(0.0F, 0.0F, 255.0F, 0.3F);
		drawBoundingBox(new AxisAlignedBB(d - 0.5D, d1 + 0.10000000000000001D, d2 - 0.5D, d + 0.5D, d1 + 2D, d2 + 0.5D));
		GL11.glDepthMask(true);
		GL11.glEnable(3553 /* GL_TEXTURE_2D */);
		GL11.glEnable(2929 /* GL_DEPTH_TEST */);
            ...
            case 1018:
                if (this.mc.renderViewEntity != null)
                {
                    ...
                    if (par1 == 1013)
                    {
                        ...
                        if(soundlocator == true) {
                        Client.addChatMessage("Wither Spawned at: "+par2+", "+par3+", "+par4);
                        }
                    }
                    else if (par1 == 1018)
                    {
                        ...
                        if(soundlocator == true) {
                        Client.addChatMessage("Dragon Killed at: "+par2+", "+par3+", "+par4);
                        }
                    }
                }
