...
public abstract class BlockFluid extends Block
{
    ...
    {
    	if(jesus == true) {
    		return AxisAlignedBB.getAABBPool().getAABB((double)par2 + this.minX, (double)par3 + this.minY - 0.1, (double)par4 + this.minZ, (double)par2 + this.maxX, (double)par3 + this.maxY - 0.1, (double)par4 + this.maxZ);
    	}
        return null;
    }
