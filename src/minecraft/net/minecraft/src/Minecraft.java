...
public class Minecraft implements IPlayerUsage
{
     ...
     */
    public static int customrightclickdelay = 4;
    ...
    private void startGame() throws LWJGLException
    {
        ...
        Display.setTitle("Loading Bl4ckHax "+Client.version);
    ...
    private void clickMouse(int par1)
    {
        if (par1 != 0 || this.leftClickCounter <= 0)
        {
            ...
            if (par1 == 1)
            {
                this.rightClickDelayTimer = customrightclickdelay;
            }
