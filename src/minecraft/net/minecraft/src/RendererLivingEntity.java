...
public abstract class RendererLivingEntity extends Render
{
    ...
    protected void renderLivingLabel(EntityLivingBase par1EntityLivingBase, String par2Str, double par3, double par5, double par7, int par9)
    {
        ...
        if (var10 <= (double)(par9 * par9))
        {
            ...
            if(nametags == true) {
            	FontRenderer var69 = this.getFontRendererFromRenderManager();
            	float distancemultiplier = (float) (Minecraft.getMinecraft().thePlayer.getDistanceSqToEntity(par1EntityLivingBase) / 400);
            	if(distancemultiplier < 1) {
            		distancemultiplier = 1;
            	}
            	float var13 = 1.6F * distancemultiplier;
               ...
               // GL11.glEnable(GL11.GL_BLEND);
                ...
                GL11.glDisable(GL11.GL_TEXTURE_2D);
                var15.startDrawingQuads();
                int var17 = var12.getStringWidth("§1"+par2Str+" §4"+(int)par1EntityLivingBase.getHealth()+"❤") / 2;
                var15.setColorRGBA_F(0.0F, 0.0F, 0.0F, 0.0F);
                ...
                var15.draw();
                GL11.glEnable(GL11.GL_TEXTURE_2D);
                var12.drawString("§1"+par2Str+" §4"+(int)par1EntityLivingBase.getHealth()+"❤", -var12.getStringWidth("§1"+par2Str+" §4"+(int)par1EntityLivingBase.getHealth()+"❤") / 2, var16, 553648127);
                GL11.glEnable(GL11.GL_DEPTH_TEST);
                GL11.glDepthMask(true);
                var12.drawString("§1"+par2Str+" §4"+(int)par1EntityLivingBase.getHealth()+"❤", -var12.getStringWidth("§1"+par2Str+" §4"+(int)par1EntityLivingBase.getHealth()+"❤") / 2, var16, -1);
                GL11.glEnable(GL11.GL_LIGHTING);
                //GL11.glDisable(GL11.GL_BLEND);
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                GL11.glPopMatrix();
